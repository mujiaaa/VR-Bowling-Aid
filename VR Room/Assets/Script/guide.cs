...
public class guide : MonoBehaviour
{
    ...
    {
        "Welcome!",
        "Bowling can be a fun and enjoyable activity, whether you're a beginner or looking to improve your game.",
        ...
        "Release the ball as it comes forward on the final swing,",
        "aiming to let go when it reaches your ankle for the most control and power.",
